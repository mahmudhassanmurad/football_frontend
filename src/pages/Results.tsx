...
const Results = () => {
  ...
  const fetchMatches = async () => {
    try {
      ...
      setMatches(completed.sort((a: Match, b: Match) => new Date(b.matchDate).getTime() - new Date(a.matchDate).getTime()));
    } catch (error) {
  ...
  if (loading) {
    return (
      <div style={{ minHeight: '100vh', backgroundColor: '#f3f4f6', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ color: '#6b7280', fontSize: isMobile ? '1rem' : '1.25rem' }}>Loading results...</div>
      </div>
    );
  }
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f3f4f6', padding: isMobile ? '1rem' : '2rem' }}>
      <header style={{ marginBottom: isMobile ? '1rem' : '2rem' }}>
        ...
        <p style={{ color: '#6b7280', fontSize: isMobile ? '0.75rem' : '0.875rem', margin: '0 0 1rem 0' }}>
          Completed match scores and results
        </p>
        <nav>
            ...
            <div key={match.id} style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: isMobile ? '0.6rem' : '0.65rem', color: '#9ca3af' }}>FT</div>
                </div>
